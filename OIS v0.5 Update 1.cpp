...
ChoiceYes:
	...
	system("CLS");	
	opt1 = "                                              ";
	opt2 = "              OIS v0.5 Update 1               ";
	opt3 = "                                              ";
	opt4 = "          1:                    Exit          ";
	opt5 = "          2:                  Log in          ";
	opt6 = "                                              ";
	Title="  Welcome to OIS GUI v1.0   ";
	cout << Columnten1<< Title<< Columnten2 << "\n" ;
	cout<< Bdr<< opt1<< Bdr<<"\n";
	cout<< Bdr<< opt2<< Bdr<<"\n";
	cout<< Bdr<< opt3<< Bdr<<"\n";
...
Pswdchkloop:
	...
	system("CLS;");
	if (Chickenvar==1){
	opt1 = " Welcome Admin                         v0.5 U1";
	}
	else {
		opt1 = " Welcome User                          v0.5 U1";
	}
	opt2 = "                 Options:                     ";
	opt3 = "-Programs                                     ";
	opt4 = "-Options                                      ";
	...
	system("CLS;");
	system("color 7f");
	opt1 = "           OIS GUI and Command Shell          ";
	opt2 = "                   System                     ";
	opt3 = "                                              ";
	opt4 = "              By Olivier Poirier              ";
	opt5 = "                                              ";
	opt6 = "Olivier Interactive Shell v0.5 Update 1       ";
	Title="         - About -          ";
	cout << Columnten1<< Title<< Columnten2 << "\n" ;
	cout<< Bdr<< opt1<< Bdr<<"\n";
	cout<< Bdr<< opt2<< Bdr<<"\n";
	...
	system("color 5d");
	system("CLS");	
	opt1 = "Standard User Detected                 v0.5 U1";
	if (Chickenvar==1){
	opt1 = "  Elevated Access  --  Hidden Items Revealed  ";
	}
	opt2 = "-Word                                         ";
	opt3 = "-Text Adventure                               ";
	opt4 = "-Exit                                         ";
	...
	opt6 = "                                              ";
	if (Chickenvar==1){
	opt6 = "-Special Documents       = PASSCODE REQUIRED =";
	}
	Title="       - Programs -         ";
	cout << Columnten1<< Title<< Columnten2 << "\n" ;
	cout<< Bdr<< opt1<< Bdr<<"\n";
	...
	if (Choice=="separate program"){
		system("CLS");	
	opt1 = "                                       v0.5 U1";
	opt2 = "   Enter name of program, and it will be      ";
	opt3 = "              opened with CMD.                ";
	opt4 = "    If the program is held in a specific      ";
	opt5 = "       directory, include that as well.       ";
	opt6 = "                                              ";
	Title="      - Run  Program -      ";
	cout << Columnten1<< Title<< Columnten2 << "\n" ;
	cout<< Bdr<< opt1<< Bdr<<"\n";
